...
class PointCloud final :
 ...
 public:
  ...
  enum : int {
    ...
    kUsedClassificationsFieldNumber = 8,
  ...
  // repeated uint32 returnNumber = 6;
  ...
  // repeated uint32 usedClassifications = 8;
...
class CityModel final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::DTCC::GridField* release_terrain();
...
inline ::DTCC::GridField* CityModel::_internal_mutable_terrain() {
  ...
  if (terrain_ == nullptr) {
    auto* p = CreateMaybeMessage<::DTCC::GridField>(GetArenaForAllocation());
    terrain_ = p;
  }
  return terrain_;
}
inline ::DTCC::GridField* CityModel::mutable_terrain() {
  ::DTCC::GridField* _msg = _internal_mutable_terrain();
...
inline void CityModel::set_allocated_terrain(::DTCC::GridField* terrain) {
  ...
  if (terrain) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::DTCC::GridField>::GetOwningArena(terrain);
    if (message_arena != submessage_arena) {
