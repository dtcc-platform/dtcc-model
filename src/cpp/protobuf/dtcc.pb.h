...
// .DTCC.Bounds bounds = 1;
inline bool VolumeGrid::_internal_has_bounds() const {
  return this != internal_default_instance() && bounds_ != nullptr;
}
...
inline const ::DTCC::Bounds& VolumeGrid::bounds() const {
  // @@protoc_insertion_point(field_get:DTCC.VolumeGrid.bounds)
  return _internal_bounds();
}
inline void VolumeGrid::unsafe_arena_set_allocated_bounds(
    ::DTCC::Bounds* bounds) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(bounds_);
  }
...
inline ::DTCC::Bounds* VolumeGrid::mutable_bounds() {
  ::DTCC::Bounds* _msg = _internal_mutable_bounds();
  // @@protoc_insertion_point(field_mutable:DTCC.VolumeGrid.bounds)
  return _msg;
}
inline void VolumeGrid::set_allocated_bounds(::DTCC::Bounds* bounds) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete bounds_;
  }
