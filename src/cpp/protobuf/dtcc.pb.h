...
class Tetrahedron PROTOBUF_FINAL :
 ...
 public:
  ...
  inline Tetrahedron* New() const final {
    return CreateMaybeMessage<Tetrahedron>(nullptr);
  }
...
class VolumeVectorField PROTOBUF_FINAL :
 ...
 public:
  ...
  inline VolumeVectorField* New() const final {
    return CreateMaybeMessage<VolumeVectorField>(nullptr);
  }
...
class PointCloud PROTOBUF_FINAL :
 ...
 public:
  ...
  ::DTCC::BoundingBox2D* release_bounds();
  ...
  ::DTCC::Georeference* release_georeference();
...
class CityModel PROTOBUF_FINAL :
 ...
 public:
  ...
  ::DTCC::GridField2D* release_terrain();
...
class Georeference PROTOBUF_FINAL :
 ...
 public:
  ...
  inline Georeference* New() const final {
    return CreateMaybeMessage<Georeference>(nullptr);
  }
...
inline ::DTCC::Georeference* PointCloud::release_georeference() {
  auto temp = unsafe_arena_release_georeference();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline ::DTCC::Georeference* PointCloud::_internal_mutable_georeference() {
  ...
  if (georeference_ == nullptr) {
    auto* p = CreateMaybeMessage<::DTCC::Georeference>(GetArena());
    georeference_ = p;
  }
...
inline ::DTCC::Georeference* PointCloud::mutable_georeference() {
  ...
  return _internal_mutable_georeference();
}
inline void PointCloud::set_allocated_georeference(::DTCC::Georeference* georeference) {
  ...
  if (georeference) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(georeference);
    if (message_arena != submessage_arena) {
...
inline ::DTCC::GridField2D* CityModel::_internal_mutable_terrain() {
  ...
  if (terrain_ == nullptr) {
    auto* p = CreateMaybeMessage<::DTCC::GridField2D>(GetArena());
    terrain_ = p;
  }
  return terrain_;
}
...
inline void Georeference::set_crs(const std::string& value) {
...
inline void Georeference::set_crs(std::string&& value) {
  
  crs_.SetLite(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:DTCC.Georeference.crs)
}
inline void Georeference::set_crs(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  crs_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:DTCC.Georeference.crs)
}
inline void Georeference::set_crs(const char* value,
    size_t size) {
  ...
  crs_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:DTCC.Georeference.crs)
}
...
inline std::string* Georeference::unsafe_arena_release_crs() {
  // @@protoc_insertion_point(field_unsafe_arena_release:DTCC.Georeference.crs)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return crs_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Georeference::unsafe_arena_set_allocated_crs(
    std::string* crs) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (crs != nullptr) {
  ...
  crs_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      crs, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:DTCC.Georeference.crs)
}
